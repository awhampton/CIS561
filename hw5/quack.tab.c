...
#line 122 "quack.tab.c" /* yacc.c:339  */
...
#line 223 "quack.tab.c" /* yacc.c:355  */
};
...
#line 240 "quack.tab.c" /* yacc.c:358  */
...
{
       0,   171,   171,   175,   176,   180,   184,   185,   189,   193,
     197,   198,   202,   206,   207,   208,   212,   216,   220,   221,
     222,   226,   230,   234,   238,   242,   246,   250,   251,   255,
     259,   260,   264,   265,   269,   273,   274,   278,   282,   283,
     287,   291,   295,   299,   303,   307,   311,   315,   319,   323,
     327,   331,   335,   339,   343,   347,   351,   355,   359,   363,
     367,   371,   375,   376,   380,   384,   385,   389
};
#endif
...
static const char *const yytname[] =
{
  ...
  "statements", "statement", "methods", "method", "opt_ident_nothing",
  "opt_ident_obj", "statement_block", "elifs", "elif_rule", "opt_else",
  "else_rule", "l_expr", "r_expr", "actual_args", "actual_arg",
...
static const yytype_int16 yypact[] =
{
     -32,    14,    19,   -32,   -15,   -32,     5,   -32,   -32,    40,
      16,   -32,   -32,     8,    69,    69,   240,    69,    69,    69,
      28,   -32,   -32,   -32,    20,   114,    23,    61,   -32,   -32,
     135,   135,   -32,   156,   226,   177,    24,    69,    25,    27,
      69,    69,    69,    69,    69,    69,    69,   -32,    29,    69,
      69,    69,    69,    33,    43,   -32,    12,   -32,   -32,   -32,
     -32,   -32,   219,    46,   -32,   -32,    69,   -18,   -18,   -18,
     -18,   -18,   226,   226,    41,   -12,   -12,    24,    24,    36,
      72,    52,   -32,   -32,    90,    13,    59,   -32,   198,    69,
     -32,    60,    78,   -32,    69,    57,   -32,   -32,   -32,    69,
     -32,   -32,    84,    22,   -32,    23,   135,   -32,   219,   -32,
      79,    74,   -32,    87,   -32,   -32,    88,    91,    81,    83,
      57,   -32,   -32,   -32
};
...
static const yytype_uint8 yydefact[] =
{
      ...
      41,    44,    43,    18,    45,     0,    11,     0,    19,    45,
       0,     0,    26,     0,    59,     0,    48,    63,     0,     0,
       0,     0,     0,     0,     0,     0,     0,    24,     0,     0,
       0,     0,     0,     0,     0,    10,     0,    20,    36,    22,
      25,    51,    66,     0,    62,    32,     0,    54,    56,    55,
      53,    52,    57,    58,    42,    46,    47,    49,    50,     0,
       9,     0,    17,    27,     0,    39,    64,    61,     0,    63,
      15,     0,     0,    34,     0,     0,    35,    21,    38,     0,
      65,    23,     0,     0,     8,    11,     0,    40,    67,    60,
       0,     0,    13,     0,    37,    14,     0,    31,     0,     0,
       0,    16,    30,    29
};
...
static const yytype_int8 yypgoto[] =
{
     ...
     -32,   -32,    -3,   -32,   -32,   -32,   -32,   -32,   -31,   -32,
     -32,   -32,   -32,    -2,   -13,    21,   -32,   -32,   -32
};
...
static const yytype_int8 yydefgoto[] =
{
     ...
     112,    12,     9,    23,    56,    83,   120,    39,    58,    85,
      96,    97,    98,    29,    25,    63,    64,    86,   100
};
...
static const yytype_int8 yytable[] =
{
      ...
      -2,    13,   -12,    38,    28,   -33,    14,    37,   111,    15,
      16,    48,    66,    88,    84,    53,    79,    65,    17,    18,
      89,    74,    13,    80,   107,   -28,    87,    14,    90,    19,
      15,    16,    20,    21,    22,   114,    62,    91,    57,    17,
      18,   106,    24,   -28,    92,    99,   108,    17,    18,   123,
      19,    13,   104,    20,    21,    22,    14,   105,    19,    15,
      16,    20,    21,    22,   109,   115,   116,   117,    17,    18,
     102,   118,    93,   121,   119,   122,   113,     0,     0,    19,
...
static const yytype_int8 yycheck[] =
{
      ...
      19,    94,    84,    22,    32,    26,    99,    18,    19,   120,
      29,     1,    32,    32,    33,    34,     6,    19,    29,     9,
      10,    32,    33,    34,    20,    26,    32,    20,    18,    19,
      89,    23,    22,    32,    23,    32,   105,    -1,    -1,    29,
...
static const yytype_uint8 yystos[] =
{
      ...
      32,    33,    34,    50,    60,    61,    19,    49,    36,    60,
      61,    61,    24,    61,    61,    61,    61,    19,    23,    54,
      11,    12,    13,    14,    15,    16,    17,    24,    27,    28,
      29,    30,    31,    32,    44,    45,    51,    21,    55,    55,
      24,    20,    61,    62,    63,    32,    25,    61,    61,    61,
      61,    61,    61,    61,    32,    61,    61,    61,    61,    23,
      20,     4,    22,    52,    49,    56,    64,    20,    61,    19,
      32,     5,    32,    22,     7,     8,    57,    58,    59,    26,
      65,    24,    62,    46,    32,    19,    61,    55,    61,    20,
       1,    26,    47,    44,    55,    26,    32,    20,    23,    23,
      53,    32,    32,    55
};
...
#line 189 "quack.y" /* yacc.c:1646  */
    { (yyval.class_signature_type) = new class_signature_node((yyvsp[-5].swln).s, (yyvsp[0].swln).s, (yyvsp[-3].formal_args_type), (yyvsp[-5].swln).ln); free((yyvsp[-5].swln).s); free((yyvsp[0].swln).s); }
#line 1470 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 193 "quack.y" /* yacc.c:1646  */
    { (yyval.class_signature_type) = new class_signature_node((yyvsp[-3].swln).s, (yyvsp[-1].formal_args_type), (yyvsp[-3].swln).ln); free((yyvsp[-3].swln).s); }
...
#line 202 "quack.y" /* yacc.c:1646  */
    { (yyvsp[0].formal_args_type)->push_front( new formal_arg_node((yyvsp[-3].swln).s, (yyvsp[-1].swln).s, (yyvsp[-3].swln).ln) ); (yyval.formal_args_type) = (yyvsp[0].formal_args_type); free((yyvsp[-3].swln).s); free((yyvsp[-1].swln).s); }
...
#line 212 "quack.y" /* yacc.c:1646  */
    { (yyval.formal_arg_type) = new formal_arg_node((yyvsp[-2].swln).s, (yyvsp[0].swln).s, (yyvsp[-2].swln).ln); free((yyvsp[-2].swln).s); free((yyvsp[0].swln).s); }
...
#line 226 "quack.y" /* yacc.c:1646  */
    { (yyval.statement_type) = new if_elifs_else_node(new condition_node((yyvsp[-3].expr_type), (yyvsp[-2].statements_type), (yyvsp[-4].ival)), (yyvsp[-1].conditionals_type), (yyvsp[0].statements_type)); }
#line 1548 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 22:
#line 230 "quack.y" /* yacc.c:1646  */
    { (yyval.statement_type) = new while_node(new while_condition_node((yyvsp[-1].expr_type), (yyvsp[0].statements_type), (yyvsp[-2].ival))); }
#line 1554 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 23:
#line 234 "quack.y" /* yacc.c:1646  */
    { (yyval.statement_type) = new assignment_node((yyvsp[-4].expr_type), (yyvsp[-3].opt_ident_type), (yyvsp[-1].expr_type), (yyvsp[-2].ival)); }
...
#line 242 "quack.y" /* yacc.c:1646  */
    { (yyval.statement_type) = new return_node((yyvsp[-1].expr_type), (yyvsp[-2].ival)); }
#line 1572 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 26:
#line 246 "quack.y" /* yacc.c:1646  */
    { (yyval.statement_type) = new return_node((yyvsp[-1].ival)); }
...
#line 255 "quack.y" /* yacc.c:1646  */
    { (yyval.method_type) = new method_node((yyvsp[-5].swln).s, (yyvsp[-1].opt_ident_type), (yyvsp[-3].formal_args_type), (yyvsp[0].statements_type), (yyvsp[-5].swln).ln); free((yyvsp[-5].swln).s); }
#line 1596 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 30:
#line 259 "quack.y" /* yacc.c:1646  */
    { (yyval.opt_ident_type) = (yyvsp[0].swln).s; }
#line 1602 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 31:
#line 260 "quack.y" /* yacc.c:1646  */
    { char id[8] = "Nothing"; char* nothing = strdup(id); (yyval.opt_ident_type) = nothing; }
...
#line 265 "quack.y" /* yacc.c:1646  */
    { char id[4] = "Obj"; char* obj = strdup(id); (yyval.opt_ident_type) = obj; }
...
#line 278 "quack.y" /* yacc.c:1646  */
    { (yyval.conditional_type) = new condition_node((yyvsp[-1].expr_type), (yyvsp[0].statements_type), (yyvsp[-2].ival)); }
...
#line 291 "quack.y" /* yacc.c:1646  */
    { (yyval.expr_type) = new ident_node((yyvsp[0].swln).s, (yyvsp[0].swln).ln); free((yyvsp[0].swln).s); }
#line 1668 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 42:
#line 295 "quack.y" /* yacc.c:1646  */
    { (yyval.expr_type) = new access_node((yyvsp[-2].expr_type), (yyvsp[0].swln).s, (yyvsp[0].swln).ln); free((yyvsp[0].swln).s); }
#line 1674 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 43:
#line 299 "quack.y" /* yacc.c:1646  */
    { (yyval.expr_type) = new strlit_node((yyvsp[0].swln).s, (yyvsp[0].swln).ln); free((yyvsp[0].swln).s); }
#line 1680 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 44:
#line 303 "quack.y" /* yacc.c:1646  */
    { (yyval.expr_type) = new intlit_node((yyvsp[0].iwln).n, (yyvsp[0].iwln).ln); }
...
#line 311 "quack.y" /* yacc.c:1646  */
    { (yyval.expr_type) = new method_call_node((yyvsp[-2].expr_type), "PLUS", (yyvsp[0].expr_type), (yyvsp[-1].ival)); }
#line 1698 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 47:
#line 315 "quack.y" /* yacc.c:1646  */
    { (yyval.expr_type) = new method_call_node((yyvsp[-2].expr_type), "MINUS", (yyvsp[0].expr_type), (yyvsp[-1].ival)); }
#line 1704 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 48:
#line 319 "quack.y" /* yacc.c:1646  */
    { (yyval.expr_type) = new method_call_node(new intlit_node(0, (yyvsp[-1].ival)), "MINUS", (yyvsp[0].expr_type), (yyvsp[-1].ival)); }
#line 1710 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 49:
#line 323 "quack.y" /* yacc.c:1646  */
    { (yyval.expr_type) = new method_call_node((yyvsp[-2].expr_type), "TIMES", (yyvsp[0].expr_type), (yyvsp[-1].ival)); }
#line 1716 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 50:
#line 327 "quack.y" /* yacc.c:1646  */
    { (yyval.expr_type) = new method_call_node((yyvsp[-2].expr_type), "DIVIDE", (yyvsp[0].expr_type), (yyvsp[-1].ival)); }
...
#line 335 "quack.y" /* yacc.c:1646  */
    { (yyval.expr_type) = new method_call_node((yyvsp[-2].expr_type), "EQUALS", (yyvsp[0].expr_type), (yyvsp[-1].ival)); }
#line 1734 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 53:
#line 339 "quack.y" /* yacc.c:1646  */
    { (yyval.expr_type) = new method_call_node((yyvsp[-2].expr_type), "ATMOST", (yyvsp[0].expr_type), (yyvsp[-1].ival)); }
#line 1740 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 54:
#line 343 "quack.y" /* yacc.c:1646  */
    { (yyval.expr_type) = new method_call_node((yyvsp[-2].expr_type), "LESS", (yyvsp[0].expr_type), (yyvsp[-1].ival)); }
#line 1746 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 55:
#line 347 "quack.y" /* yacc.c:1646  */
    { (yyval.expr_type) = new method_call_node((yyvsp[-2].expr_type), "ATLEAST", (yyvsp[0].expr_type), (yyvsp[-1].ival)); }
#line 1752 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 56:
#line 351 "quack.y" /* yacc.c:1646  */
    { (yyval.expr_type) = new method_call_node((yyvsp[-2].expr_type), "MORE", (yyvsp[0].expr_type), (yyvsp[-1].ival)); }
#line 1758 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 57:
#line 355 "quack.y" /* yacc.c:1646  */
    { (yyval.expr_type) = new and_node((yyvsp[-2].expr_type), (yyvsp[0].expr_type), (yyvsp[-1].ival)); }
#line 1764 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 58:
#line 359 "quack.y" /* yacc.c:1646  */
    { (yyval.expr_type) = new or_node((yyvsp[-2].expr_type), (yyvsp[0].expr_type), (yyvsp[-1].ival)); }
#line 1770 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 59:
#line 363 "quack.y" /* yacc.c:1646  */
    { (yyval.expr_type) = new not_node((yyvsp[0].expr_type), (yyvsp[-1].ival)); }
#line 1776 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 60:
#line 367 "quack.y" /* yacc.c:1646  */
    { (yyval.expr_type) = new method_call_node((yyvsp[-5].expr_type), (yyvsp[-3].swln).s, (yyvsp[-1].actual_args_type), (yyvsp[-3].swln).ln); free((yyvsp[-3].swln).s); }
#line 1782 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 61:
#line 371 "quack.y" /* yacc.c:1646  */
    { (yyval.expr_type) = new class_instantiation_node((yyvsp[-3].swln).s, (yyvsp[-1].actual_args_type), (yyvsp[-3].swln).ln); free((yyvsp[-3].swln).s); }
#line 1788 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 62:
#line 375 "quack.y" /* yacc.c:1646  */
...
#line 1812 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 66:
#line 385 "quack.y" /* yacc.c:1646  */
    { (yyval.actual_args_type) = new list<actual_arg_node *>(); }
#line 1818 "quack.tab.c" /* yacc.c:1646  */
    break;

  case 67:
#line 389 "quack.y" /* yacc.c:1646  */
    { (yyval.actual_arg_type) = new actual_arg_node((yyvsp[0].expr_type)); }
#line 1824 "quack.tab.c" /* yacc.c:1646  */
    break;


#line 1828 "quack.tab.c" /* yacc.c:1646  */
      default: break;
    }
